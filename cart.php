...
if (empty($_SESSION['cart'])) {
    ...
    $count = count($cart);
    $productCountText = ($count == 1) ? 'Er staat 1 product in je winkelwagen.' : 'Er staan ' . $count . ' producten in je winkelwagen.';
    echo "<p>$productCountText</p>\n";
    ...
    <table>
        ...
        foreach ($cart as $products) {
            ...
            if (strlen(trim($product[1])) <> 0) {
                ...
                echo "</tr>\n</tbody>";
                // Total
                $total += $lineprice;         // Totaal updaten
            }
        }
        ?>
        <tfoot>
